...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BWhF1Yw6.mjs");
...
var manifest = { "aa7b8da9106f9d50e82b82a6fa778e86e290738047d4cb72fe225ebd818f3e1c": {
	functionName: "askMonkey_createServerFn_handler",
	importer: () => import("./chat-BjV8J5vt.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-ESN6uk90.mjs").then((n) => n.t),
